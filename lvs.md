...
#### <span id="1.3.2">1.3.2 可伸缩Web和媒体服务</span> ####
...
#### <span id="1.3.3">1.3.3 可伸缩Cache服务</span> ####
...
#### <span id="1.3.4">1.3.4 可伸缩邮件服务</span> ####
...
#### <span id="1.4.2">1.4.2</span> 基于BGP的地理分布服务器集群调度####
...
#### <span id="1.4.3">1.4.3</span> 服务器集群间的负载均衡####
...
### <span id="2.1">2.1 通过NAT实现虚拟服务器（VS/NAT）</span> ###
...
### <span id="2.2">2.2 通过IP隧道实现虚拟服务器（VS/TUN）</span> ###
...
### <span id="2.3">2.3 通过直接路由实现虚拟服务器（VS/DR）</span> ###
...
### <span id="2.4">2.4 三种方法的优缺点比较</span> ###
...
### <span id="3.1">3.1 内核中的连接调度算法</span> ###
...
#### <span id="3.1.1">3.1.1 轮叫调度（Round-Robin Scheduling）</span> ####
...
#### <span id="3.1.2">3.1.2 加权轮叫调度（Weighted Round-Robin Scheduling）</span> ####
#### <span id="3.1.3">3.1.3 最小连接调度（Least-Connection Scheduling）</span> ####
#### <span id="3.1.4">3.1.4 加权最小连接调度（Weighted Least-Connection Scheduling）</span> ####
#### <span id="3.1.5">3.1.5 基于局部性的最少链接（Locality-Based Least Connections Scheduling）</span> ####
#### <span id="3.1.6">3.1.6 带复制的基于局部性最少链接（Locality-Based Least Connections with Replication Scheduling）</span> ####
#### <span id="3.1.7">3.1.7 目标地址散列调度（Destination Hashing Scheduling）</span> ####
#### <span id="3.1.8">3.1.8 源地址散列调度（Source Hashing Scheduling）</span> ####


### <span id="3.2">3.2 动态反馈负载均衡算法</span> ###
#### <span id="3.2.1">3.2.1 连接调度</span> ####
#### <span id="3.2.2">3.2.2 动态反馈负载均衡机制</span> ####
#### <span id="3.2.3">3.2.3 综合负载</span> ####
#### <span id="3.2.4">3.2.4 权值计算</span> ####
#### <span id="3.2.5">3.2.5 一个实现例子</span> ####


### <span id="3.3">3.3 小结</span> ###



## <span id="4">4.  IP虚拟服务器的实现和性能测试</span> ##
## <span id="5">5. 内核中的基于内容请求分发</span> ##
## <span id="6">6. TCPHA的设计与实现</span> ##